...
namespace ASCOM.Simulator
{
    ...
    /// ASCOM Switch Driver for Simulator.
    /// </summary>
    [Guid("70336b94-8593-4504-99bd-1d0bf4b968c1")]
    [ClassInterface(ClassInterfaceType.None)]
    public class Switch : ISwitchV2
    {
        private EventLog evtLog = new EventLog();
        ...
        /// </summary>
        private static string driverDescription = "ASCOM Switch Driver for Simulator.";
