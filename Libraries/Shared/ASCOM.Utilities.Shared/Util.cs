...
namespace ASCOM.Utilities
{
    ...
    public class Util : IUtil, IUtilExtra, IDisposable
    {
        ...
        public string SerialTraceFile
        {
            get
            {
                return dStore.GetProfile("","SerialTraceFile", m_SerTraceFile);
            }
            set
            {
                m_SerTraceFile = value;
                dStore.WriteProfile("", "SerialTraceFile", value);
            }
        }
        ...
        public bool SerialTrace
        {
            get
            {
                return dStore.GetProfile("", "SerialTrace", !String.IsNullOrWhiteSpace(m_SerTraceFile));
            }
            set
            {
                dStore.WriteProfile("", "SerialTrace", value);
            }
        }
        ...
        public Util()
        {
            ...
            dStore = (IAscomDataStore)new RegistryAccess();
