...
namespace xASCOM.Simulator
{
    ...
    public class Camera : ICameraV2
    {
        ...
        private TraceLogger Log { get; set; }
        // supported actions
        ...
        {
            if (coolerOn && canSetCcdTemperature)
            {
                coolerPower = Math.Min(100, Math.Max((ccdTemperature - setCcdTemperature) * 100, 0));
                ccdTemperature -= (coolerPower / 50);     // reduce temperature by up to 2 deg per sec.
            }
            // increase temperature by 2 deg per sec at a differential of 40
            ccdTemperature += (heatSinkTemperature - ccdTemperature) / 20.0;
        }
        ...
        {
            Log.LogStart("StartExposure", $"Duration {Duration}, Light {Light}");
...
#region ICameraV2 properties
        ...
        public short BayerOffsetX
        {
            get
            {
                ...
                CheckCapability("BayerOffsetX", sensorType != SensorType.Monochrome);
        ...
        public short BayerOffsetY
        {
            get
            {
                ...
                CheckCapability("BayerOffsetY", sensorType != SensorType.Monochrome);
