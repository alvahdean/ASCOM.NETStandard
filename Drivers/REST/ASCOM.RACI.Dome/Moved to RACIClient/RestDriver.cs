...
namespace ASCOM.RACI
{
    ...
    /// </summary>
    [Guid("18c229a2-5a78-4fff-881e-e6067b6f1cdf")]
    ...
    public class RestDriver
    {
        ...
        internal static bool traceStateDefault = false;
        ...
        public bool Connected
        {
            ...
            set
            {
                tl.LogMessage(nameof(Connected), $"Set {value}");
                _connected = value;
            }
        }
        ...
        public string Description
        {
            ...
            set
            {
                tl.LogMessage(nameof(Description), $"Set {value}");
                _description = value;
            }
        }
        ...
        public string DriverInfo
        {
            ...
            set
            {
                tl.LogMessage(nameof(DriverInfo), $"Set {value}");
                _driverInfo = value;
            }
        }
        ...
        public string DriverVersion
        {
            ...
            set
            {
                tl.LogMessage(nameof(DriverVersion), $"Set {value}");
                _driverVersion = value;
            }
        }

        private short _interfaceVersion = 0;
        public short InterfaceVersion
        {
            get => _interfaceVersion;
            set
            {
                tl.LogMessage(nameof(InterfaceVersion), $"Set {value}");
        ...
        public string Name
        {
            ...
            set
            {
                tl.LogMessage(nameof(Name), $"Set {value}");
                _name = value;
            }
        }
