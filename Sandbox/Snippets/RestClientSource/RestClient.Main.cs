...
namespace RACI.Client
{
    ...
    /// </summary>
    public partial class _RestClient : IRestClient
    {
        ...
        public _RestClient(Uri baseUrl) : this()
        {
            BaseUrl = baseUrl;
        }
        ...
        /// </summary>
        /// <param name="baseUrl"></param>
        public _RestClient(string baseUrl) : this()
        {
        ...
        private void AuthenticateIfNeeded(_RestClient client, IRestRequest request) =>
